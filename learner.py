...
class LearnerCNN(Learner):
  def __init__(self, width, height, channels, num_outputs, batch_size=64, exp_size=400000, min_epsilon=0.1, epsilon_decay=0.999995, learning_rate=1e-4, dropout=0.5, target_update_interval=2000):
    self._width  = width
    self._height = height
